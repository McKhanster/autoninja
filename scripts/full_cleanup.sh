#!/bin/bash
# Full cleanup script for AutoNinja nested stacks
set -e
...
echo -e "${BLUE}╔══════════════════════════════════════════════════════════════════════════════╗${NC}"
echo -e "${BLUE}║         AUTONINJA FULL CLEANUP SCRIPT                                        ║${NC}"
echo -e "${BLUE}╚══════════════════════════════════════════════════════════════════════════════╝${NC}"
echo ""
...
# Empty artifacts bucket (created by stack)
empty_bucket "$ARTIFACTS_BUCKET"
delete_bucket "$ARTIFACTS_BUCKET"

echo ""

# Empty deployment bucket (may be created manually or by script)
empty_bucket "$DEPLOYMENT_BUCKET"
delete_bucket "$DEPLOYMENT_BUCKET"

echo ""

# Step 2: Delete the main CloudFormation stack (which will delete nested stacks)
echo -e "${YELLOW}═══════════════════════════════════════════════════════════════════════════════${NC}"
...
echo -e "${GREEN}╚══════════════════════════════════════════════════════════════════════════════╝${NC}"
echo ""
echo "All AutoNinja resources have been cleaned up:"
