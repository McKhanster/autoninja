#!/bin/bash
# Script to deploy Solution Architect Lambda function

set -e

# Configuration
FUNCTION_NAME="autoninja-solution-architect-production"
HANDLER_DIR="lambda/solution-architect"
BUILD_DIR="build/solution-architect"
ZIP_FILE="build/solution-architect.zip"
...
echo "========================================="
echo "Deploying Solution Architect Lambda"
echo "========================================="
